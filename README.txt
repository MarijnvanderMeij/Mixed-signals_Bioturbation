...
Instructions for downloading Julia can be found here: https://julialang.org/downloads/. This manual is written for Windows operating systems. 

The model, in the form of a Jupyter Notebook (https://jupyter.org/) can be executed in your browser via Jupyter Notebook or in the integrated development environment Visual Studio Code.
...
- Jupyter Notebook 
    - Open the Jupyter Notebook program. This will start the Notebook in your browser
